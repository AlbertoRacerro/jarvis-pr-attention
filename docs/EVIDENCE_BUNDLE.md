...
- `REVIEW_VALIDATED`: a structured review result has been validated.
...
Verification recomputes component identities and all cross-component bindings from embedded evidence. Exit code `97` means the bundle is invalid or cannot be verified safely.
